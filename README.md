...
- **اَلْمُصْحَفُ — Mushaf reader (v1.1):** all 114 surahs, Tanzil-verified text bundled in the app (offline-safe, no AI-generated Quran), real qari recitation per ayah (Mishary Alafasy), tap-word dictionary lookup, and a bookmark that remembers exactly where you stopped so you can open the app and continue reciting.
